$(document).ready(function() {
	var vue = new Vue({
		...
		methods : {
			...
			openAddWin: function() {
				DialogTemplate.showPage('添加', 450, 400, 'refUserAdd.html');
			},
			showUpdateWin: function(userCode) {
				DialogTemplate.showPage('更新', 450, 400, 'refUserUpdate.html' + '?userCode=' + userCode);
			},
			showUpdatePWDWin: function(userCode) {
				DialogTemplate.showPage('密码更新', 380, 330, '../user/userPWDUpdate.html' + '?userCode=' + userCode);
			},
