...
<body>
	<form action="tocompleteMerchantInfo.jsp" method="post" id="appform"
		name="appform" enctype="multipart/form-data">
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="1" class="table_xz2">
			 <tr>
				<td style="background-color: #DDDDDD; width: 150px;">请求测试地址:</td>
				<td><input type="text" name="url" value="http://localhost:8080/nn-ysb-http-web/receive/completeMerchantInfo"  style="width: 800px;" class="{requiredBy:{src:'#bywrite',srccheck:'check'}}" /><font color="red">*</font></td>
			</tr>
			...
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				银行账户姓名：</td>
				<td><input id="bankAccountName" name="bankAccountName"
					 value=""
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				银行卡号：</td>
				<td><input id="bankAccountNo" name="bankAccountNo"
					 value=""
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				身份证号码：</td>
				<td><input id="idCard" name="idCard"
					 value=""
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				身份证开始时间：</td>
				<td><input id="idCardStart" name="idCardStart"
					 value=""
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				身份证截止时间：</td>
				<td><input id="idCardEnd" name="idCardEnd"
					 value=""
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
			...
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				银行卡正面照：</td>
				<td><input id="bankCardPhoto" name="bankCardPhoto" type="file"
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				身份证正面照：</td>
				<td><input id="idCardPhoto" name="idCardPhoto" type="file"
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				身份证反面照：</td>
				<td><input id="idCardBackPhoto" name="idCardBackPhoto" type="file"
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				身份证+银行卡+本人合照：</td>
				<td><input id="personPhoto" name="personPhoto" type="file"
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
