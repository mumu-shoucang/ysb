...
<body>
	<form action="toMerchantWithdraw.jsp" method="post" id="appform"
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="1" class="table_xz2">
			 <tr>
				...
				<td><input type="text" name="url" value="http://192.168.10.229:8080/nn-ysb-http-web/receive/withdraw"  style="width: 800px;" class="{requiredBy:{src:'#bywrite',srccheck:'check'}}" /><font color="red">*</font></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				结算金额：</td>
				<td><input id="withdrawAmt" name="withdrawAmt"
					 value="5"
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
