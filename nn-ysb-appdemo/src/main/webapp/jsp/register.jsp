...
<body>
	<form action="toregister.jsp" method="post" id="appform"
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="1" class="table_xz2">
			 <tr>
				...
				<td><input type="text" name="url" value="http://localhost:8081/nn-ysb-http-web/receive/register"  style="width: 800px;" class="{requiredBy:{src:'#bywrite',srccheck:'check'}}" /><font color="red">*</font></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="background-color: #DDDDDD; width: 150px;">
				邀请码：</td>
				<td><input id="refCode" name="refCode"
					 value=""
					style="width: 300px;" type="text" maxlength="60" /><font color="red">*</font>
				</td>
			</tr>
