...
<body>
	<form action="tologin.jsp" method="post" id="appform"
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="1" class="table_xz2">
			 <tr>
				...
				<td><input type="text" name="url" value="http://192.168.10.229:8080/nn-ysb-http-web/receive/login"  style="width: 800px;" class="{requiredBy:{src:'#bywrite',srccheck:'check'}}" /><font color="red">*</font></td>
			</tr>
			<tr>
